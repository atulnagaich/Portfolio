...
import tech.atul.portfolio.service.AddAbountIntro;
import tech.atul.portfolio.service.ContactService;
import tech.atul.portfolio.service.ServicesService;
...
public class MyController {
    ...
    @Autowired
	private AddAbountIntro   abountIntro;;;
    ...
    public void downloadResume(HttpServletRequest request,HttpServletResponse response) throws  Exception {
		...
		response.setHeader("Content-Disposition", "attachment; filename=AtulNagaich.pdf");
