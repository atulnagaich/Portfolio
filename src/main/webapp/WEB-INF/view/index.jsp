				...
				<div class="row">
					<div class="col-lg-7">
						...
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Atul</h1>
					...
					<div class="col-lg-5">
						<div class="home_right_img">
							<div class="profile-circle">
								<img
									src="${pageContext.request.contextPath}/img/banner/profile.jpg"
									alt="Atul profile photo" loading="lazy" decoding="async">
							</div>
						</div>
					</div>
